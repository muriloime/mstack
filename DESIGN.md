# Design System — mstack

## Product Context
- **What this is:** Community website for mstack — a CLI tool that turns Claude Code into a virtual engineering team
- **Who it's for:** Developers discovering mstack, existing community members
