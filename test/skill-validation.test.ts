...
describe("v0.4.1 preamble features", () => {
  ...
  const tier1Skills = ["SKILL.md", "browse/SKILL.md"];
...
describe("Test Bootstrap ({{TEST_BOOTSTRAP}}) integration", () => {
  ...
  test("WebSearch is in allowed-tools for qa and design-review", () => {
...
// --- Review step numbering regression guard ---

describe("review step numbering", () => {
...
// Codex skill tests removed — codex/ deleted in repo simplification
...
// Codex skill validation tests removed — codex/ deleted in repo simplification
...
// Test failure triage in ship skill tests removed — ship/ deleted in repo simplification
