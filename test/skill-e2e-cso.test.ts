...
- Save the report to .mstack/security-reports/.`,
    ...
    const reportDir = path.join(csoDir, '.mstack', 'security-reports');
...
- Skip the preamble (mstack-update-check, telemetry, etc.) — go straight to the audit.
