...
describe("Audit compliance", () => {
  ...
  // Telemetry tests removed — telemetry was removed in repo simplification
  ...
  // Extension background.js test removed — extension directory deleted in repo simplification
  ...
  // Telemetry SKILL.md conditional check removed — telemetry removed in repo simplification
});
