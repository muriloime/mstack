...
export function generateVendoringDeprecation(ctx: TemplateContext): string {
  return `If \`VENDORED_MSTACK\` is \`yes\`, warn once via AskUserQuestion unless \`~/.mstack/.vendoring-warned-$SLUG\` exists:
...
3. Run \`${ctx.paths.binDir}/mstack-team-init required\` (or \`optional\`)
