 ...
 *   1. If ~/.mstack-artifacts-remote.txt (or legacy ~/.mstack-brain-remote.txt
 *      during the v1.27.0.0 migration window) exists AND ~/.mstack/.git is
...
_BRAIN_CONFIG_BIN="${ctx.paths.binDir}/mstack-config"
